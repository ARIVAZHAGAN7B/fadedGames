...
function ResultPanel({ room, state, onLeaveRoom, onRestartGame, onRestartDisabled }) {
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-3">
        <header className="surface flex flex-col gap-3 p-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-extrabold uppercase text-mint">Spy Word Room</p>
